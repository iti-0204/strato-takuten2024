  ...
  switch (type) {
    case "btnM":
      return (
        <button
          className={
            "bg-gradient-to-br from-primary to-buttonGrad text-white font-en tracking-en rounded text-base h-8 w-38"
          }
        >
    ...
    case "btnL":
      return (
        <button
          className={
            "bg-gradient-to-br from-primary to-buttonGrad text-white font-en tracking-en text-xl rounded h-12 w-48"
          }
        >
